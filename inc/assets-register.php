 ...
 * Register theme assets
 */
if ( ! function_exists( 'CassidyDC\BlockTheme\register_theme_assets' ) ) :
	/**
	 * Register theme assets
	 *
	 * @since 1.0.0
...
add_action( 'wp_enqueue_scripts', 'CassidyDC\BlockTheme\register_theme_assets' );

/**
 * Register editor UI assets
 */
if ( ! function_exists( 'CassidyDC\BlockTheme\register_editor_ui_assets' ) ) :
	/**
	 * Register editor UI assets
	 *
	 * @since 1.0.0
...
add_action( 'enqueue_block_editor_assets', 'CassidyDC\BlockTheme\register_editor_ui_assets' );

/**
 * Register theme block pattern categories
 */
if ( ! function_exists( 'CassidyDC\BlockTheme\register_theme_block_pattern_categories' ) ) :
	/**
	 * Register theme block pattern categories
	 *
	 * @since 1.0.0
...
add_action( 'init', 'CassidyDC\BlockTheme\register_theme_block_pattern_categories' );
