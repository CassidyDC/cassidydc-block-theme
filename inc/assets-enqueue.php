 ...
 */
if ( ! function_exists( 'CassidyDC\BlockTheme\enqueue_theme_assets' ) ) :
	/**
...
add_action( 'wp_enqueue_scripts', 'CassidyDC\BlockTheme\enqueue_theme_assets' );

/**
 * Enqueue editor UI assets
 */
if ( ! function_exists( 'CassidyDC\BlockTheme\enqueue_editor_ui_assets' ) ) :
	/**
...
add_action( 'enqueue_block_editor_assets', 'CassidyDC\BlockTheme\enqueue_editor_ui_assets' );

/**
 * Enqueue editor iframe content stylesheets
 */
if ( ! function_exists( 'CassidyDC\BlockTheme\enqueue_editor_styles' ) ) :
	/**
...
add_action( 'after_setup_theme', 'CassidyDC\BlockTheme\enqueue_editor_styles' );

/**
 * Enqueue individual block stylesheets
 */
if ( ! function_exists( 'CassidyDC\BlockTheme\enqueue_block_styles' ) ) :
	/**
	 * Enqueue individual block stylesheets
	 *
	 * @since 1.0.0
...
add_action( 'after_setup_theme', 'CassidyDC\BlockTheme\enqueue_block_styles' );
